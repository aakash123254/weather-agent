...
root_agents = Agent(
    ...
    ## RESPONSE FORMAT 
    When providing weather information, structure your response as follows:
    
    1. **Location Summary** : City name, country, coordinates
    2. **Current Conditions** : Temperature, feels like, humidity, wind, conditions 
    3. **Detailed Metrics** : Pressure, visiblity, cloudiness, etc.
    4. **Forecast** (when requested): Organised by day/time with key metrics
    ...
    ## ERROR HANDLING 
    When errors occur, provide helpful and user-friendly response:
    ...
    It feels like  14°C (57°F) with 65% humidity and a gentel breeze of 3.5 m/s from the southwest.
    Atmospheric pressure is 1012 hPa with 40% cloud cover and visiblity of 10km .
    ...
    📊 Temperature Trend: Warming ↗️
       ...
       Analysis indiactes a steady warming trend with mostly partly cloudy conditions."
       ...
       Please check the spelling or try a nearby major city insetead.
